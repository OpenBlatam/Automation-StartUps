...
def create_professional_pdf():
    ...
    doc = SimpleDocTemplate(
        ...
        creator="Sistema de Transcripción y Formateo Digital Profesional",
        keywords="ciencia ficción, clonación, identidad, tecnología, futuro, manuscrito, literatura"
    )
    
    styles = getSampleStyleSheet()
    
    # Paleta de colores profesional
    primary_color = HexColor('#1e3a8a')      # Azul profesional
    secondary_color = HexColor('#374151')   # Gris profesional
    accent_color = HexColor('#dc2626')      # Rojo profesional
    gold_color = HexColor('#d97706')        # Dorado profesional
    text_gray = HexColor('#4b5563')         # Gris texto
    light_gray = HexColor('#f9fafb')        # Gris claro
    border_gray = HexColor('#d1d5db')      # Gris borde
    ...
    # Información del manuscrito profesional
    info_text = """
    <para align="center" fontSize="16" fontName="Helvetica" textColor="#4b5563">
    ...
    Estilo: Narrativa Experimental | Formato: Edición Profesional
    </font>
    </para>
    """
    ...
    index_table = Table(index_data, colWidths=[2*cm, 10*cm, 2*cm])
    ...
    preservando la estructura y estilo del autor.</i>
    </para>
    """
    ...
    # Nota al pie
    story.append(Paragraph("¹ G.R.E.E.: Posiblemente un acrónimo relacionado con la gestión de recursos genéticos.", footnote_style))
    story.append(PageBreak())
    ...
    # Poesía formateada
    senti_text = """
    <para align="center" fontSize="15" fontName="Times-Italic" textColor="#4b5563" leading="21">
    ...
    Formato: PDF Profesional | Fecha: """ + datetime.now().strftime("%B %Y") + """
    </font>
    </para>
    """
    ...
    def add_page_number(canvas, doc):
        ...
        canvas.setStrokeColor(HexColor('#d97706'))
    ...
    print("PDF profesional creado exitosamente: bioclones_novela_professional.pdf")
