---
title: "Plan Gestion Crisis Continuidad"
category: "04_business_strategy"
tags: []
created: "2025-10-29"
path: "04_business_strategy/Other/Plans/plan_gestion_crisis_continuidad.md"
---
...
```mermaid
graph TD
    A[CEO - Presidente CMT] --> B[COO - Vice Presidente]
    A --> C[CMO - Director Comunicaciones]
    A --> D[CTO - Director Técnico]
    A --> E[CHRO - Director HR]
    
    B --> F[Equipo Operaciones]
    C --> G[Equipo Comunicaciones]
    D --> H[Equipo Técnico]
    E --> I[Equipo Recursos Humanos]
    
    F --> J[Coordinadores de Área]
    G --> K[Especialistas en Comunicación]
    H --> L[Especialistas Técnicos]
    I --> M[Especialistas en HR]
```
