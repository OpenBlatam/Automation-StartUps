...
tags: []
created: "2025-10-29"
path: "07_risk_management/plan_contingencia_ia_bulk_documentos.md"
---
...
## 38. VENDOR SCORECARD (PROVEEDORES LLM)

| Proveedor | Calidad Promedio | Costo/Doc | Latencia p95 | Confiabilidad | Soporte | Cumplimiento | Nota |
|-----------|-------------------|-----------|--------------|---------------|--------|--------------|------|
| OpenAI | [X]/5.0 | $[X] | [X] ms | 99.[X]% | 9/10 | SOC2 | [Comentario] |
| Anthropic | [X]/5.0 | $[X] | [X] ms | 99.[X]% | 9/10 | SOC2 | [Comentario] |
| Together | [X]/5.0 | $[X] | [X] ms | 99.[X]% | 8/10 | — | [Comentario] |

Criterios: calidad, coste, latencia, límites, SLA, soporte, compliance, roadmap.

---

## 39. SOP: GESTIÓN DE CAMBIOS DE MODELO (MODEL CHANGE MGMT)

1) Detección
- Suscribirse a notificaciones de cambios de proveedores
- Canary tests semanales en prompts críticos

2) Validación
- Evals estandarizados (calidad, formato, longitud, factualidad)
- Umbrales de aceptación por tipo de documento

3) Aprobación
- Revisión de resultados por dueño de producto + ingeniería
- Registro de versión de modelo en metadatos de cada doc

4) Despliegue controlado
- 10% de tráfico canary → 50% → 100%
- Rollback automático si KPI cae > X%

5) Comunicación y documentación
- Changelog interno y aviso a clientes enterprise si impacta

---

## 40. POLÍTICA DE CALIDAD, FAIRNESS Y SESGOS

- Monitoreo de sesgos por categoría (género, región, industria)
- Lista de chequeo de lenguaje inclusivo y neutral
- Métricas: Toxicidad, polaridad, alucinaciones, sesgos detectados
- Escalado humano para casos sensibles (premium HITL)
- Proceso de rectificación y retraining de prompts

---

## 41. SOP: ROLLBACK DE PROMPTS Y CONFIGURACIONES

Criterios de rollback:
- Caída de calidad > 10% en 24h
- Aumento de regeneraciones > 15%
- Quejas de clientes clave o formatos inválidos

Pasos:
1) Congelar cambios (feature flag OFF)
2) Volver a versión estable (prompt_version N-1)
3) Invalidar cache asociado si aplica
4) Comunicar a CSMs/Soporte el rollback
5) Abrir post-mortem y evaluar fix forward
...
**Última actualización:** 2025-01-27  
**Próxima revisión:** Trimestral (próxima: [Fecha])
**Versión del Plan:** 6.1 (Master AI Edition + Governance/Scorecard)
