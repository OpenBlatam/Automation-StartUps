# 👥 Onboarding de Equipo para Outreach

> **Guía completa para incorporar nuevos miembros al equipo de outreach a influencers**
...
- Conocer herramientas y recursos
...
**Día 4-5: Proceso**
- [ ] Revisar guías principales
- [ ] Entender flujo de trabajo
- [ ] Conocer herramientas
- [ ] Ver ejemplos de trabajo previo

**Entregables:**
- Acceso a todas las herramientas
- Lista de recursos clave
...
- [ ] Usar hashtags correctos
- [ ] Aplicar criterios
- [ ] Revisar con supervisor

**Verificación:**
- [ ] Verificar 5 perfiles
- [ ] Calcular engagement
- [ ] Evaluar fit
- [ ] Documentar en sistema

**Contacto:**
- [ ] Personalizar 3 mensajes
- [ ] Revisar con supervisor
- [ ] Enviar 1 mensaje (supervisado)
- [ ] Recibir feedback

**Entregables:**
- 10 candidatos identificados
- 5 perfiles verificados
- 3 mensajes personalizados
- Feedback recibido

---

### Semana 3: Independencia Gradual

**Objetivos:**
- Trabajar más independientemente
...
- [ ] Buscar 20 candidatos
- [ ] Verificar 10 perfiles
- [ ] Agregar a sistema
- [ ] Revisión semanal
...
- [ ] Onboardear 2 colaboradores
- [ ] Proporcionar materiales
- [ ] Gestionar timeline
- [ ] Seguimiento activo

**Entregables:**
- 20 candidatos identificados
- 5 contactos realizados
- 2 colaboraciones gestionadas
- Contribución activa
...
### Video 2: Búsqueda y Verificación (20 min)

**Contenido:**
- Cómo buscar influencers
...
### Video 3: Contacto y Negociación (25 min)
...
### Video 4: Gestión de Colaboraciones (20 min)
...
### Semana 2
- [ ] Búsqueda practicada
- [ ] Verificación dominada
- [ ] Mensajes personalizados
- [ ] Feedback recibido

### Semana 3
- [ ] Trabajo independiente
- [ ] Colaboraciones gestionadas
- [ ] Problemas resueltos
- [ ] Contribución activa
...
**Semana 1:**
- Comprensión del producto: [Test/Quiz]
- Acceso a herramientas: 100%
- Recursos revisados: [X]%

**Semana 2:**
- Candidatos identificados: [X]
- Perfiles verificados: [X]
- Mensajes personalizados: [X]

**Semana 3:**
- Contactos realizados: [X]
- Colaboraciones gestionadas: [X]
- Problemas resueltos: [X]

**Semana 4:**
- Operación independiente: Sí/No
- Contribuciones al equipo: [X]
...
¡Bienvenido/a al equipo de outreach!

Estoy emocionado/a de tenerte con nosotros. Tu rol será [descripción breve].

Para empezar:
1. Revisa [documento 1]
2. Configura [herramienta 1]
3. Agenda nuestra primera reunión
