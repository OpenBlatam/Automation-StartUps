...
# IMPORTANTE: db será inyectado por app.py cuando se carga este módulo
# No importar db aquí directamente para evitar importaciones circulares
...
class KPIMetric(db.Model):
    ...
    metadata_json = db.Column(db.Text)  # Renombrado de 'metadata' porque está reservado en SQLAlchemy
    created_at = db.Column(db.DateTime, default=datetime.utcnow)
