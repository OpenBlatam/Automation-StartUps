...
```mermaid
graph TB
    subgraph "Tier 1 Markets (Immediate Entry)"
        A[United States<br/>$12.8B] --> B[United Kingdom<br/>$2.1B]
        B --> C[Germany<br/>$1.8B]
        C --> D[Australia<br/>$1.2B]
    end
    
    subgraph "Tier 2 Markets (12-18 Months)"
        E[Canada<br/>$1.1B] --> F[France<br/>$1.0B]
        F --> G[Netherlands<br/>$0.8B]
        G --> H[Singapore<br/>$0.6B]
    end
    
    subgraph "Tier 3 Markets (18-36 Months)"
        I[Japan<br/>$0.9B] --> J[India<br/>$0.7B]
        J --> K[Brazil<br/>$0.5B]
        K --> L[Mexico<br/>$0.4B]
    end
    
    subgraph "Tier 4 Markets (36+ Months)"
        M[Argentina<br/>$0.3B] --> N[Chile<br/>$0.2B]
        N --> O[UAE<br/>$0.1B]
        O --> P[South Africa<br/>$0.1B]
    end
```
