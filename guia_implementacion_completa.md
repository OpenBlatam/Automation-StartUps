...
```mermaid
gantt
    title Cronograma de Implementación HR
    dateFormat  YYYY-MM-DD
    section Fase 1
    Preparación           :prep, 2024-01-01, 30d
    Fundación            :found, after prep, 60d
    section Fase 2
    Core HR              :core, after found, 90d
    IA y Automatización  :ai, after core, 60d
    section Fase 3
    Expansión            :expand, after ai, 90d
    Optimización         :opt, after expand, 60d
```
