# Guía de Referencia Rápida - Tipos de Documentos AI Bulk
...
en una empresa de 100 empleados del sector retail, incluyendo 
...
con objetivo de facilitar implementación"
```
...
**Consulta ejemplo:**
```
"Crear un artículo de blog sobre las tendencias de IA en 
marketing digital para 2024, dirigido a profesionales de 
marketing, con tono profesional y 1500 palabras"
```
...
### Longitud por Tipo
- **Propuestas**: 5-15 páginas
- **Reportes**: 10-30 páginas
- **Manuales**: 20-100 páginas
- **Artículos**: 1000-3000 palabras
- **Presentaciones**: 10-30 slides
- **Emails**: 200-500 palabras

### Tono por Audiencia
- **Ejecutivos**: Formal, conciso, orientado a resultados
- **Técnicos**: Detallado, preciso, con ejemplos
- **Marketing**: Persuasivo, creativo, orientado a beneficios
- **Clientes**: Amigable, claro, orientado a soluciones
- **Interno**: Directo, informativo, orientado a procesos

### Formato por Uso
- **Presentación**: PowerPoint, PDF optimizado
- **Impresión**: Word, PDF con márgenes
- **Web**: HTML, Markdown
- **Email**: Texto plano, HTML
- **Móvil**: Formato responsive
...
- **Propuestas**: 90%+ aprobación, 70%+ conversión
- **Reportes**: 95%+ precisión, 85%+ satisfacción
- **Manuales**: 90%+ claridad, 80%+ completitud
- **Artículos**: 85%+ engagement, 90%+ legibilidad
- **Presentaciones**: 90%+ comprensión, 85%+ impacto

### Tiempo de Generación
- **Documentos simples**: 2-5 minutos
- **Documentos complejos**: 5-15 minutos
- **Documentos extensos**: 15-30 minutos
- **Documentos técnicos**: 10-20 minutos
- **Documentos creativos**: 5-10 minutos
...
- **Formato corporativo**: Colores, fuentes, logo
- **Tono de marca**: Formal, casual, técnico
- **Estructura**: Secciones, subsecciones
- **Elementos visuales**: Gráficos, tablas, imágenes
...
### Generación Masiva
- **Bulk Document Creation**: Creación masiva de documentos
- **Template Automation**: Automatización de templates
